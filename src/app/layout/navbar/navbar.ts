...
export class Navbar implements OnInit {
  ...
  protected notifText(n: Notification): string {
    ...
    const map: Record<NotificationType, string> = {
      ...
      ANSWER_TO_QUESTION: `${actor} respondeu sua pergunta ${title}`,
      ANSWER_ACCEPTED: `Sua resposta resolveu a pergunta ${title}`,
      GAME_NEW_QUESTION: `Nova pergunta em um jogo que você segue: ${title}`,
